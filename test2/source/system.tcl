...
proc create_root_design { parentCell } {
  ...
  set enet_refclk [ create_bd_port -dir O -type clk enet_refclk ]
  set_property -dict [ list \
  ...
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $rx_mac_aclk
  ...
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $tx_mac_aclk
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT2_PORT {clkout125} \
   CONFIG.CLK_OUT3_PORT {clkout25} \
  ...
  set_property -dict [ list \
   CONFIG.ETHERNET_BOARD_INTERFACE {eth_mii} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins tri_mode_ethernet_mac_0/s_axi]
  ...
  connect_bd_intf_net -intf_net s_axis_pause_0_1 [get_bd_intf_ports s_axis_pause] [get_bd_intf_pins tri_mode_ethernet_mac_0/s_axis_pause]
  connect_bd_intf_net -intf_net s_axis_tx_0_1 [get_bd_intf_ports s_axis_tx] [get_bd_intf_pins tri_mode_ethernet_mac_0/s_axis_tx]
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_m_axis_rx [get_bd_intf_ports m_axis_rx] [get_bd_intf_pins tri_mode_ethernet_mac_0/m_axis_rx]
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_mdio_internal [get_bd_intf_ports eth_mdio_mdc] [get_bd_intf_pins tri_mode_ethernet_mac_0/mdio_internal]
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_mii [get_bd_intf_ports eth_mii] [get_bd_intf_pins tri_mode_ethernet_mac_0/mii]

  # Create port connections
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins microblaze_0_xlconcat/In1]
  connect_bd_net -net clk_wiz_1_clkout25 [get_bd_ports enet_refclk] [get_bd_pins clk_wiz_1/clkout25]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_ports axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clkout100] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins tri_mode_ethernet_mac_0/s_axi_aclk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins tri_mode_ethernet_mac_0/glbl_rstn]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_ports axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins tri_mode_ethernet_mac_0/rx_axi_rstn] [get_bd_pins tri_mode_ethernet_mac_0/s_axi_resetn] [get_bd_pins tri_mode_ethernet_mac_0/tx_axi_rstn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs tri_mode_ethernet_mac_0/s_axi/Reg] -force
