...
proc create_root_design { parentCell } {
  ...
  set clkout100 [ create_bd_port -dir O -type clk clkout100 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CLK_OUT1_PORT {clkout166} \
    CONFIG.CLK_OUT2_PORT {clkout200} \
    CONFIG.CLK_OUT3_PORT {clkout100} \
  ...
  connect_bd_intf_net -intf_net axi_datamover_0_M_AXI_S2MM [get_bd_intf_pins axi_datamover_0/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clkout166] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clkout200] [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_0_clkout100 [get_bd_pins clk_wiz_0/clkout100] [get_bd_ports clkout100]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_ports axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn] [get_bd_ports axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins axi_datamover_0/m_axi_s2mm_aresetn]
